...
@SuperBuilder
@Getter
public class EconomicIndicatorSearchResponse extends ApiSearchResponse {

  @Schema(requiredMode = REQUIRED, description = "経済指標マスタリスト")
  private List<EconomicIndicatorDto> list;
